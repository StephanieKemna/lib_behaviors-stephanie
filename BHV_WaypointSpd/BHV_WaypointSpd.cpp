...
IvPFunction *BHV_WaypointSpd::buildOF(string method)
{
  ...
  if((method == "roc") || (method == "rate_of_closure")) {
    ...
    m_commanded_speed = cruise_speed;
...
void BHV_WaypointSpd::markOdoLeg()
{
  ...
  if (m_commanded_speed > 0) {
    time_leg_linear = dist_leg_linear / m_commanded_speed;
